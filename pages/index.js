      ...
      <div>
        <div className='lg:container mx-auto lg:px-0 p-5  md:px-16 z-50 '>
          ...
          <div className=' relative'>
            <div className='w-full -mt-10 flex relative overflow-hidden  z-0 '>
              <div className='scroll-text text-gray-900 sm:text-9xl text-8xl whitespace-nowrap font-domine uppercase'>
